...
<a:p>
  ...
  <a:r><a:rPr lang="es-ES" sz="${Math.round(fontSize * 0.8)}" b="0" dirty="0"><a:solidFill><a:srgbClr val="9CA3AF"/></a:solidFill><a:latin typeface="Calibri (MS)"/></a:rPr><a:t>  ${dims}</a:t></a:r>
</a:p>`
    }).join('')
